    ...
    if (ImGui::TreeNode("Basic"))
    {
        ...
        for (int i = 0; i < 7; i++)
        {
            if (i > 0)
                ImGui::SameLine();
            ImGui::PushID(i);
            ImGui::PushStyleColor(ImGuiCol_Button,        {0.20f, 0.40f, 0.70f, 1.f}); // azul medio
            ImGui::PushStyleColor(ImGuiCol_ButtonHovered, {0.30f, 0.60f, 1.00f, 1.f}); // azul claro hover
            ImGui::PushStyleColor(ImGuiCol_ButtonActive,  {0.10f, 0.25f, 0.50f, 1.f}); // azul oscuro click
